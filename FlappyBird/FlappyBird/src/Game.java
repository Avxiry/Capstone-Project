...
public class Game extends JPanel implements Runnable, MouseListener {
    ...
    public void start() {
        try {
            ...
            background = ImageIO.read(new File("E:/MOD 3/CIS 404/FlappyBird/FlappyBird/assets/background.png"));
            floor = ImageIO.read(new File("E:/MOD 3/CIS 404/FlappyBird/FlappyBird/assets/floor.png"));
            ...
            topPipe = ImageIO.read(new File("E:/MOD 3/CIS 404/FlappyBird/FlappyBird/assets/top_pipe.png"));
            bottomPipe = ImageIO.read(new File("E:/MOD 3/CIS 404/FlappyBird/FlappyBird/assets/bottom_pipe.png"));
    ...
    public void saveRecordToFile() {
        String directoryPath = "E:/MOD 3/CIS 403/TEST/shop/static/shop/styles"; // Specify the directory path here

        try (BufferedWriter writer = new BufferedWriter(new FileWriter(directoryPath + "/score.txt", true))) {
            writer.write(Integer.toString(record) + "\n"); // Appending a new line for each score
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
